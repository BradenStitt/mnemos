...
function captureAndStoreMemory() {
  ...
  chrome.storage.sync.get(
    ...
    function (items) {
      ...
      // Send memory to your service asynchronously without waiting for response
      console.log("Storing memory:", message);
      fetch("http://localhost:8000/api/store-memory", {
        ...
        console.log("Memory storage response:", response);
        return response.json();
      }).then(data => {
        console.log("Memory storage success:", data);
      }).catch((error) => {
...
async function handleMem0Modal(sourceButtonId = null) {
  ...
  // No authentication needed - service is always available
  ...
  try {
    ...
    console.log("Searching for memories with query:", message);
    ...
    console.log("Processed memory items:", memoryItems);
